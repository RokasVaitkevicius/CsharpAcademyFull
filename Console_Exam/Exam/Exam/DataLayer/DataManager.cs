...
namespace Exam.DataLayer
{
    public abstract class DataManager
    {
        public virtual string GetMetric(ComputerMetricsEnum type)
        {
            ...
            switch (type)
            {
                ...
                case ComputerMetricsEnum.Cpu:

                    value = GetValueFromWmi("Win32_Processor", "Name");
                    break;

                case ComputerMetricsEnum.RamUsage:
                ...
                case ComputerMetricsEnum.AvailableDiskSpaceGb:
                ...
                case ComputerMetricsEnum.AverageDiskQueueLength:
    ...
    {
        public static long BytesToGygabytes(this long bytes) => bytes / 1024 / 1024 / 1024;
    }
}
